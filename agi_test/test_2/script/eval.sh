...
CKPT_DIR="/storage1/hs/agi_test/1024_gpu_only/checkpoints/0000000100"
EVAL_DUMP_DIR="/storage1/hs/agi_test_eval/gpu_only"
...
CUDA_VISIBLE_DEVICES=0 python -m apps.main.eval \
    config="/home/hs/farnn/memory/agi_test/test_2/config/eval.yaml" \
    ckpt_dir="${CKPT_DIR}" \
